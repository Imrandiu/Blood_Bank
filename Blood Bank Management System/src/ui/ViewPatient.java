...
private void viewTable()
    {
            try {
            String sql = "select id as 'Patient ID',Name,Email,Contact,Address,Age,Sex,BG as'Blood Group',(select Date from issued where client.id=issued.PID order by Date desc LIMIT 1) as 'Last received' from client order by id desc";
    ...
    private void initComponents() {
        ...
        menu.setMaximumSize(new java.awt.Dimension(304, 600));
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        // TODO add your handling code here:
        UpdatePatient pat=new UpdatePatient();
        pat.show();
        this.hide();
