...
PreparedStatement pst=null;
    ...
    private void viewTable()
    {
        try {
            ...
            String sql = "select id as 'Serial NO',PID,NBG as 'Blood Group',Quantity,Date as 'When Needed' from requests order by id desc";
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Serial NO", "Patient ID", "Blood Group", "Quantity", "When Needed"
            }
        ) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
        UpdateRequests requ=new UpdateRequests();
        requ.show();
        this.hide();
