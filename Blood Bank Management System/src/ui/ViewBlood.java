...
PreparedStatement pst=null;
     ...
     private void viewTable()
    {
        try {
            ...
            String sql = "select id as 'Blood Code',DonorId as 'Donor ID',BG as 'Blood Group',Quantity, CDate as 'Collecting Date', EDate as 'Expiring Date' from blood order by id desc";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
        UpdateBlood update=new UpdateBlood();
        update.show();
        //this.show();
