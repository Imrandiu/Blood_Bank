...
PreparedStatement pst=null;
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        try{
            ...
            String sql="Select * from donor where id= '" + txtID.getText() + "'";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try{
            ...
            String sql= "update donor set Name='"+ txtname.getText() + "',Email='"+ txtEmail.getText() + "',Contact='"+ txtContact.getText() + "',Address='"+ txtAddress.getText() + "',Sex='"+ cmbGender.getSelectedItem().toString() + "',Age='"+ txtAge.getText() + "',BG='"+ cmbBG.getSelectedItem().toString() + "' where id='" + txtID.getText() + "'";
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try{
            ...
            {
                con=DBClass.getConnection();
                String sql= "delete from Donor where id = '" + txtID.getText() + "'";
                pst=con.prepareStatement(sql);
                pst.execute();
